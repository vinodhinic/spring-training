...
@ActiveProfiles("noPartialCartCheckout")
@ContextConfiguration(classes = {AppConfig.class})
public class NoPartialCheckoutKindleCartTest {
    ...
    public void test() {
        ...
        Map<String, Integer> isbnToStock = kindleDao.selectAllBookStocks().stream()
                .collect(Collectors.toMap(BookStock::getIsbn, BookStock::getStock));
        assertEquals(2, isbnToStock.get("A0").intValue());
        ...
        assertEquals(1000, account.get(0).getBalance().intValue());
